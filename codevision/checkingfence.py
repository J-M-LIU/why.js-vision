...
from codevision.insertingcontrol3 import controltime,stop_threads
from codevision.oldcare.track import CentroidTracker
from codevision.oldcare.track import TrackableObject
...
def checkfence(videocamera=VideoCamera):
    # 得到当前时间
    ...
    args = {'filename': 'tests/test_Trim.mp4'}
                ...
                # to determine direction
                    ...
                    if not to.counted:
                        ...
                        if direction < 0 and centroid[1] < H // 2:
                            ...
                            command = '%s codevision/inserting3.py --event_desc %s --event_type 4 --event_location % s' \
...
def set_frame(grabbed,frame):
    if grabbed:
        ...
        globalvar.set_global_frame3(jpeg.tobytes())
        globalvar.set_is_begin(True)
    else:
        globalvar.set_global_frame3(None)
